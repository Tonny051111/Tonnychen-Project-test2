...
#### PC:
[![My Skills](https://skillicons.dev/icons?i=github,apple,androidstudio,powershell,windows,linux,ubuntu,arch,vscode,visualstudio,pycharm,c,cpp,cs,py,html,git,ps,pr,ae,vim,qt,cloudflare,gmail,gcp,twitter,instagram,discord&perline=16)](https://skillicons.dev)
#### Mobile:
